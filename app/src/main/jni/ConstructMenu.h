    ...
    if (itsmk) {
        ...
        if (ImGui::Begin("NeoXClientUI", &itsmk, windowFlags))
        {
            ...
            if (!isMenuCollapsed) {
                ...
                if (ImGuiX::DripTab("VISUAL", activeTab == 3, tabWidth)) activeTab = 3;
                ...
                ImGui::BeginChild("Content", ImVec2(0,0), false, ImGuiWindowFlags_AlwaysVerticalScrollbar);
                {
                    ...
                    else if (activeTab == 1)
                    {
                        ...
                        ImGui::Separator();
                        ImGui::TextColored(ImVec4(1.00f, 0.00f, 1.00f, 1.00f), "IMPERIUM MODZ");
                        ImGuiX::DripCheckbox("IMPERIUM Speed Hack", &SpeedHack_Enabled);
                        if(SpeedHack_Enabled) {
                            ImGui::SliderFloat("Speed x", &SpeedMultiplier, 1.0f, 3.0f);
                        }
                        ImGui::Separator();
                    ...
                    {           
                        ImGui::TextColored(ImVec4(0.00f, 0.70f, 1.00f, 1.00f), "VISUAL SETTINGS");
                        ImGui::Separator();
                        ImGui::Spacing();
